...
module.exports = {
  input: {
    path: "./abac_permissions_demo/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./abac_permissions_demo/locale", // output path of all created files
